...
from src_both.lib.validation import validation_scores_and_bounds_from_split_data
from src_both.lib.consts import DATASET_SHIFTS, TRAIN_METHODS, BOUND_STRATEGIES
from src_both.lib.utils import load_shift_data, np_to_device
...
parser.add_argument("--results_dir", type=str, default='results_both/')
...
filename = os.path.join(
    args.results_dir,
    f'dis2_{args.epochs}epochs_{args.critic_repeats}repeats_valfrac{args.val_frac:0.2f}_weighting{args.weighting}_detlayers{args.detector_layers}_detwidth{args.detector_width_factor}_srcclmp{args.source_clamp}_trgclmp{args.target_clamp}_srcwt{args.source_train_weighting}_trgwt{args.target_train_weighting}_trgthresh{args.target_loss_threshold}_srcthresh{args.source_loss_threshold}_criticstrat{args.best_critic_strategy}_bal{args.detector_bal}.pkl'
)
total_evals = 0
